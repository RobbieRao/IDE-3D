...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Let's Enjoy 3D-Aware Face Manipulation"))
    ...
    def add_update_img_button(self, Form):
        ...
        self.updateButton.setGeometry(QtCore.QRect(900, 60, 120, 40))
        self.updateButton.setText(_translate("Form", "Rendering"))
        self.updateButton.setStyleSheet("background-color: %s;" % number_color[19]+ " color: black")
        ...
        self.updateStyleButton.setGeometry(QtCore.QRect(1040, 60, 120, 40))
        self.updateStyleButton.setText(_translate("Form", "Change Style"))
        self.updateStyleButton.setStyleSheet("background-color: %s;" % number_color[19]+ " color: black")
        self.updateStyleButton.setObjectName("change style")
        self.updateStyleButton.clicked.connect(Form.change_style)


        self.updateStyleButton = QtWidgets.QPushButton(Form)
        self.updateStyleButton.setGeometry(QtCore.QRect(1460, 60, 100, 40))
        ...
        self.updateStyleButton = QtWidgets.QPushButton(Form)
        self.updateStyleButton.setGeometry(QtCore.QRect(1180, 60, 120, 40))
        ...
        self.updateStyleButton = QtWidgets.QPushButton(Form)
        self.updateStyleButton.setGeometry(QtCore.QRect(1320, 60, 120, 40))
    ...
    def add_tool_buttons(self, Form):
        ...
        self.brushButton.setIcon(QIcon('Painter/icons/paint_brush.png'))
    ...
    def add_style_imgs_buttons(self, Form):
        ...
        style_button.setIcon(QIcon('Painter/icons/random.png'))
