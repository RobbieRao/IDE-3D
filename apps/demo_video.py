...
render_option = 'freeze_bg,steps:36'
...
def check_name(model_name='FFHQ512'):
    ...
    if model_name == 'FFHQ512':
        network_pkl = "./pretrained_models/stylenerf/ffhq_512.pkl"
    elif model_name == 'FFHQ512v2':
        network_pkl = "./pretrained_models/stylenerf/ffhq_512.v2.pkl"
    elif model_name == 'AFHQ512':
        network_pkl = "./pretrained_models/stylenerf/afhq_512.pkl"
    elif model_name == 'MetFaces512':
        network_pkl = "./pretrained_models/stylenerf/metfaces_512.pkl"
    elif model_name == 'CompCars256':
        network_pkl = "./pretrained_models/stylenerf/cars_256.pkl"
    elif model_name == 'FFHQ1024':
        network_pkl = "./pretrained_models/stylenerf/ffhq_1024.pkl"
    else:
